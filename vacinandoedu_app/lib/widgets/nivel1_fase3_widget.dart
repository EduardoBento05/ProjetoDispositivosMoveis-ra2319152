...
class Nivel1Fase3Widget extends StatefulWidget {
  ...
  @override
  State<Nivel1Fase3Widget> createState() => _Nivel1Fase3WidgetState();
}

class _Nivel1Fase3WidgetState extends State<Nivel1Fase3Widget> {
  List<Question> _questions1 = [
    Question(
      id: '4',
      title: "Quantos anos atras a variolação foi desenvolvida pelos Chineses?",
      options: const {
        '1000': true,
        '2000': false,
        '430': false,
    ...
    Question(
      id: '5',
      title: "Em que animal foi transmitido um dos primeiros casos de Varíola",
      options: const {
        'Papagaio': false,
        'Gato': false,
        'Vaca': true,
